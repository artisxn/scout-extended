...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | codicastudio provides robust "typo-tolerance" out-of-the-box. This parameter accepts an
    ...
    */
    ...
    | codicastudio to compute a set of possible values that can later be used to create categories
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The easiest way to manage your settings is usually to go to your codicastudio dashboard because
