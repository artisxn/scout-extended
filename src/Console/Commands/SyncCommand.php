...
use codicastudio\ScoutExtended\Settings\Status;
use codicastudio\ScoutExtended\Settings\Synchronizer;
...
final class SyncCommand extends Command
{
    ...
    public function handle(
        ...
        foreach ($searchableFinder->fromCommand($this) as $searchable) {
            ...
            $status = $synchronizer->analyse($index = $codicastudio->index($searchable));
