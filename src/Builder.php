...
final class Builder extends BaseBuilder
{
     ...
     * {@inheritdoc}
     *
     * @see https://github.com/codicastudio/scout-extended/issues/98
     */
     ...
     *
     * @link https://www.codicastudio.com/doc/guides/geo-search/geo-search-overview
     *
     ...
     *
     * @link https://www.codicastudio.com/doc/api-reference/search-api-parameters
     *
    ...
    public function with(array $parameters): self
    {
        ...
        $this->callback = function ($codicastudio, $query, $baseParameters) use ($parameters, $callback) {
            $parameters = array_merge($parameters, $baseParameters);

            if (is_callable($callback)) {
                return $callback($codicastudio, $query, $parameters);
            }

            return $codicastudio->search($query, $parameters);
        };
