...
use codicastudio\ScoutExtended\Facades\codicastudio;
use App\User;
use App\Wall;
use Tests\TestCase;
...
final class SearchKeyTest extends TestCase
{
    public function testWhenSearchApiDontExists(): void
    {
        ...
        $this->assertSame(codicastudio::searchKey(User::class), 'barSecured');
    }
    ...
    public function testWhenSearchApiAlreadyExists(): void
    {
        ...
        $this->assertSame(codicastudio::searchKey(new Wall()), 'barSecured');
    }
}
