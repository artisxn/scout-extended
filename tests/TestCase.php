...
use codicastudio\codicastudioSearch\Response\AbstractResponse;
...
use codicastudio\ScoutExtended\ScoutExtendedServiceProvider;
...
abstract class TestCase extends BaseTestCase
{
    ...
    {
        return [
            'codicastudio' => codicastudioFacade::class,
        ];
    }
    ...
    {
        $engineMock = mock(app(codicastudioEngine::class))->makePartial()->shouldIgnoreMissing();
    ...
    protected function mockIndex(string $model, array $settings = [], array $userData = null): MockInterface
    {
        ...
        $codicastudioEngine = app(codicastudioEngine::class);

        $codicastudioEngine->setClient($clientMock);

        $engineMock = mock($codicastudioEngine)->makePartial();
